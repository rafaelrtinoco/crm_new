...
is((select count(*) from public.plataforma_admins), 1::bigint, 'admin vê a própria linha em plataforma_admins');

reset request.jwt.claims;
set local request.jwt.claims = '{"sub": "b0000000-0000-0000-0000-000000000101", "role": "authenticated"}';

is((select count(*) from public.plataforma_admins), 0::bigint, 'usuário comum não vê a linha de admin de outra pessoa');
